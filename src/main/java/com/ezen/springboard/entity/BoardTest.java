...
public class BoardTest {
	...
	@Id
	// 키 값 생성 전략
	// GeneratedValue: GeneratedValue 어노테이션을 선언하지 않으면 키 값을 직접 할당해줘야 함
	// GeneratedValue의 속성
	// AUTO: 기본값, 데이터베이스에서 알아서 키 값을 할당
	// IDENTITY: AUTO_INCREMENT를 사용하여 키 값을 할당
